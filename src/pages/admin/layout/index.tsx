...
export const Layout = () => {
    ...
    return (
        // < !--Body Wrapper-- >
        <div className={`page-wrapper ${isMiniSidebar ? "mini-sidebar" : ""} ${isShowSidebar ? "show-sidebar" : ""}`} id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype={isMiniSidebar ? 'mini-sidebar' : 'full'}
            ...
            <aside className="left-sidebar">
                ...
                <div className="scroll-sidebar" data-simplebar>
                    <div className="d-flex mb-4 align-items-center justify-content-between">
                        <a href="index.html" className="text-nowrap logo-img ms-0 ms-md-1 d-flex">
                            <img src={logo} height="40" alt="" /><h1>Thỏ Stay</h1>
                        </a>
                        <div className="close-btn d-xl-none d-block sidebartoggler cursor-pointer" id="sidebarCollapse" onClick={() => {
                            handleSidebarToggle();
                    ...
                    <nav className="navbar navbar-expand-lg navbar-light">
                        <ul className="navbar-nav">
                            <li className="nav-item d-block d-xl-none">
                                <a className="nav-link sidebartoggler nav-icon-hover" id="headerCollapse" href="javascript:void(0)" onClick={() => {
                                    handleSidebarToggle();
                                    handleShowSidebarToggle();
                                }}>
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                                        <div className="message-body">
                                            ...
                                            <a href="./authentication-login.html" className="btn btn-outline-primary mx-3 mt-2 d-block shadow-none">Đăng xuất</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
