...
const Deleteuseroom: React.FC<DeleteuseroomProps> = ({ onClose, roomId, userId, userName }) => {
				...
				<div className='modal-content-admin position-relative p-4'>
					<div>
						<h2 className='h2-modal-duyet text-center'>
							Bạn có chắc chắn muốn xóa người <span style={styleNameUser}>{userName}</span> thuê này khỏi phòng?
						</h2>
					</div>
