                    ...
                    {files.map((file, index) => (
                      ...
                      >
                        ...
                        {file.type.includes("image") ? (
                          ...
                          <div className="file-display position-absolute d-flex align-items-end h-100">
                            ...
                            {/* Tên file */}
                            <p className="file-name ms-2">{file.name}</p>
                          </div>
                        )}
                        <button
                          type="button"
