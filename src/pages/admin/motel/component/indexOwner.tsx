...
export const indexOwner = () => {
	...
	const handleAddMotel = () => {
		if ((myPackage && myPackage.limitMotel && count < myPackage.limitMotel) || (count === 0 && myPackage?.limitMotel === undefined)) {
	...
	const chekcIsInfoMotel = (status: number) => {
